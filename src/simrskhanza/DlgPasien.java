...
public class DlgPasien extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        KecamatanPj.setBounds(790, 360, 130, 23);
        ...
        BtnKecamatanPj.setBounds(960, 360, 28, 23);
        ...
        BtnKabupatenPj.setBounds(750, 390, 28, 23);
        ...
        BtnKelurahanPj.setBounds(750, 360, 28, 23);
        ...
        PropinsiPj.setBounds(790, 390, 130, 23);
        ...
        btnPropinsiPj.setBounds(960, 390, 28, 23);
...
private void KabupatenMouseMoved(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_KabupatenMouseMoved
    ...
    private void getDataTni() {
        if(tbPasien2.getSelectedRow()!= -1){
            ...
            TTlpPJ.setText(tbPasien2.getValueAt(tbPasien2.getSelectedRow(),39).toString());
    ...
    private void getDataPolri() {
        if(tbPasien3.getSelectedRow()!= -1){
            ...
            TTlpPJ.setText(tbPasien3.getValueAt(tbPasien3.getSelectedRow(),39).toString());
